...
$sql = "SELECT image FROM pictures where division_id=1 ";
    ...
    <div class="container-fluid">
        <div class="row" >
            <div class="col-lg-6 col-md-6">
               <br>
                ...
                <video width="640" height="480" controls autoplay>
                    <source src="dhaka_land.mp4" muted autoplay loop class="video" >
            ...
            <div class="col-lg-6 col-md-6">
                ...
                <p class="py-2"><br><br><br><br>
                <h1 class="text-left"> Dhaka: The city of mosque</h1>

                <h3> <br> Dhaka is the capital of Bangladesh which is located in the central portion. It is a city of versatility and a lot of art & structure. There are a lot of places to go and things to do inside and near Dhaka. Dhaka is famous for so many things. It is called the city of the mosque or the city of rickshaw (a local transport).
                </h3> </p>
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-4 col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h2 class="card-title">Ahsan Manzil</h2>
                        <br>
            ...
            <div class="col-lg-4 col-md-4 col-12">
                <div class="card">
                    <img class="card-img-top" src="images/panam.jpg" height="350" alt="Card image">
                    <div class="card-body">
                        <h2 class="card-title" >Panam Nagar</h2>
                        <br>
                        <a href="#" class="btn btn-primary">Explore more</a>
                    </div>
                </div>
