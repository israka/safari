...
$sql = "SELECT image FROM pictures where division_id=5  ";
        ...
        <div class="row" >
            <div class="col-lg-6 col-md-6">
                ...
                <video width="640" height="480" controls autoplay>
                    <source src="rajshahi_land.mp4" muted autoplay loop class="video" >
            ...
            <div class="col-lg-6 col-md-6">
                ...
                <p class="py-2">
                <h1 class="text-center"> Rajshahi</h1>
                <br>
                <h3> <br>Rajshahi is one of the most traditional ancient cities of Bangladesh, located on the banks of the Padma River. Rajshahi district, famous for its mango and silk textiles, is the largest city in the whole Rajshahi division.
                    Rich in the history of ancient Bengal, Rajshahi city has famous mosques, temples, and historical structures. The popular tourist destinations of this city on the banks of Padma include Bagha Masjid, Puthia Rajbari, Padma’s Bank, Barendra Research Museum, Rajshahi University, Children’s Park, Hawakhana, Padma Garden, Zoo, etc.
...
<section class="my-5">
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-4 col-md-4 col-12">
                <div class="card">
                    <img class="card-img-top" src="images/puthia rajshahi.jpg" height="350" alt="Card image">
                    <div class="card-body"  >
