        ...
        <div class="row" >
            <div class="col-lg-6 col-md-6">
                <div class="container"><br><br><br>
                    ...
                    $sql = "SELECT image FROM pictures where division_id=5 and place_id=1";
...
<section class="my-5">
    ...
    <div class="container-fluid">
        <div class="row" >
            <div class="col-lg-6 col-md-6">
                <h3>
                    Mahasthangarh (Pundranagar), the ancient capital of Pundravardhana is located 11 km (6.8 mi) north of Bogra on the Bogra-Rangpur highway, with a feeder road (running along the eastern side of the ramparts of the citadel for 1.5 km) leading to Jahajghata and site museum.<br>
            ...
            <div class="col-lg-6 col-md-6">
                ...
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d28939.663559273286!2d89.33315462472932!3d24.950529426719587!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39fcfee6067b1e7f%3A0x549459f98fc4c276!2sMohasthan%20Garh!5e0!3m2!1sen!2sbd!4v1650651136388!5m2!1sen!2sbd" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            </div>
        </div>
    </div>
</section>
<section class="my-5">
    ...
    <div class="container-fluid">
        <h3>
            Buses are available for Bogra from Dhaka and take 4½ hours for the journey via Bangabandhu Jamuna Bridge across the Jamuna River. <br>Buses are available from Bogra to Mahasthangarh. Rickshaws are available for local movement. Hired transport is available at Dhaka/ Bogra. Accommodation is available at Bogra. When travelling in a hired car, one can return to Dhaka the same day, unless somebody has a plan to visit Somapura Mahavihara at Paharpur in the district of Naogaon and other places, or engage in a detailed study.
        </h3>
...
<section class="my-5">
    ...
    <div class="container-fluid">
        <a href="https://www.youtube.com/watch?v=t_ypudl7mBw"><font size=5px><b>click here</b></a>
