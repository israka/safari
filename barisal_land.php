...
$sql = "SELECT image FROM pictures where division_id=2  ";
        ...
        <div class="row" >
            <div class="col-lg-6 col-md-6">
                ...
                <video width="640" height="480" controls autoplay>
                    <source src="barisal_land.mp4" muted autoplay loop class="video" >
            ...
            <div class="col-lg-6 col-md-6">
                ...
                <p class="py-2">
                <h1 class="text-center"> Barishal</h1>
                <br>
                <h3> <br> Barishal district is known as Venice of Bengal. Lakutia Zamindar House, Durgasagar Dighi, Guthia Masjid, Floating Guara Bazar, Satla Shapla Village, Bibir Pukur, Brajmohan College, Jibananda Das’s House, Oxford Mission Church, Bangabandhu Park (Bells Park), Barisal University, Shwetpadma Pukur, Mukund Das’s Kalibari and Sher-e-Bangla Museum, etc. are the most visited and notable best places to visit in Barisal.
                </h3> </p>
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-4 col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h2 class="card-title">Floating Guava Market</h2>
                        <br>
            ...
            <div class="col-lg-4 col-md-4 col-12">
                <div class="card">
                    ...
                    <div class="card-body"  >
                        <h2 class="card-title" >Oxfrod Mission</h2>
                        <br>
